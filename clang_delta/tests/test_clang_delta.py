...
class TestClangDelta(unittest.TestCase):
    ...
    def test_callexpr_to_value_test3(self):
        self.check_clang_delta(
            'callexpr-to-value/test3.c',
            '--transformation=callexpr-to-value --counter=1',
        )
        self.check_clang_delta_hints(
            'callexpr-to-value/test3.c',
    ...
    def test_copy_propagation_copy2(self):
        self.check_clang_delta(
            'copy-propagation/copy2.cpp',
            '--transformation=copy-propagation --counter=2',
        )

    def test_empty_struct_to_int_empty_struct(self):
        self.check_clang_delta(
            'empty-struct-to-int/empty-struct.cpp',
            '--transformation=empty-struct-to-int --counter=1',
        )

    def test_empty_struct_to_int_empty_struct2(self):
        self.check_clang_delta(
            'empty-struct-to-int/empty-struct2.cpp',
            '--transformation=empty-struct-to-int --counter=1',
        )

    def test_empty_struct_to_int_empty_struct3(self):
        self.check_clang_delta(
            'empty-struct-to-int/empty-struct3.cpp',
            '--transformation=empty-struct-to-int --counter=2',
        )

    def test_empty_struct_to_int_empty_struct4(self):
        self.check_clang_delta(
            'empty-struct-to-int/empty-struct4.cpp',
            '--transformation=empty-struct-to-int --counter=1',
        )

    def test_empty_struct_to_int_empty_struct5(self):
        self.check_clang_delta(
            'empty-struct-to-int/empty-struct5.cpp',
            '--transformation=empty-struct-to-int --counter=1',
        )
    ...
    def test_local_to_global_unnamed_1(self):
        self.check_clang_delta(
            'local-to-global/unnamed_1.c',
            '--transformation=local-to-global --counter=1',
        )

    def test_local_to_global_unnamed_2(self):
        self.check_clang_delta(
            'local-to-global/unnamed_2.c',
            '--transformation=local-to-global --counter=1',
        )

    def test_local_to_global_unnamed_3(self):
        self.check_clang_delta(
            'local-to-global/unnamed_3.c',
            '--transformation=local-to-global --counter=2',
        )
    ...
    def test_remove_namespace_macro(self):
        ...
        self.check_clang_delta(
            'remove-namespace/macro.cpp',
            '--transformation=remove-namespace --counter=3',
        ...
        self.check_clang_delta(
            'remove-namespace/macro.cpp',
            '--transformation=remove-namespace --counter=5',
            'remove-namespace/macro.output5',
        )

    def test_remove_namespace(self):
        self.check_clang_delta(
            'remove-namespace/namespace.cpp',
            '--transformation=remove-namespace --counter=1',
        )
        self.check_clang_delta(
            'remove-namespace/namespace.cpp',
    ...
    def test_remove_namespace2(self):
        self.check_clang_delta(
            'remove-namespace/namespace2.cpp',
            '--transformation=remove-namespace --counter=1',
        )
        self.check_clang_delta(
            'remove-namespace/namespace2.cpp',
    ...
    def test_remove_namespace3(self):
        self.check_clang_delta(
            'remove-namespace/namespace3.cpp',
            '--transformation=remove-namespace --counter=1',
        )
        self.check_clang_delta(
            'remove-namespace/namespace3.cpp',
    ...
    def test_remove_namespace4(self):
        self.check_clang_delta(
            'remove-namespace/namespace4.cpp',
            '--transformation=remove-namespace --counter=1',
        )

    def test_remove_namespace5(self):
        self.check_clang_delta(
            'remove-namespace/namespace5.cpp',
            '--transformation=remove-namespace --counter=1',
        )
        self.check_clang_delta(
            'remove-namespace/namespace5.cpp',
    ...
    def test_remove_namespace6(self):
        self.check_clang_delta(
            'remove-namespace/namespace6.cpp',
            '--transformation=remove-namespace --counter=1',
        )
        self.check_clang_delta(
            'remove-namespace/namespace6.cpp',
    ...
    def test_remove_namespace7(self):
        self.check_clang_delta(
            'remove-namespace/namespace7.cpp',
            '--transformation=remove-namespace --counter=1',
        )
        self.check_clang_delta(
            'remove-namespace/namespace7.cpp',
    ...
    def test_remove_namespace8(self):
        self.check_clang_delta(
            'remove-namespace/namespace8.cpp',
            '--transformation=remove-namespace --counter=1',
        )
        self.check_clang_delta(
            'remove-namespace/namespace8.cpp',
    ...
    def test_remove_namespace9(self):
        self.check_clang_delta(
            'remove-namespace/namespace9.cpp',
            '--transformation=remove-namespace --counter=1',
        )

    def test_remove_namespace10(self):
        self.check_clang_delta(
            'remove-namespace/namespace10.cpp',
            '--transformation=remove-namespace --counter=1',
        )
        self.check_clang_delta(
            'remove-namespace/namespace10.cpp',
    ...
    def test_remove_namespace11(self):
        self.check_clang_delta(
            'remove-namespace/namespace11.cpp',
            '--transformation=remove-namespace --counter=1',
        )
        self.check_clang_delta(
            'remove-namespace/namespace11.cpp',
    ...
    def test_remove_namespace12(self):
        self.check_clang_delta(
            'remove-namespace/namespace12.cpp',
            '--transformation=remove-namespace --counter=1',
        )
        self.check_clang_delta(
            'remove-namespace/namespace12.cpp',
    ...
    def test_remove_namespace13(self):
        self.check_clang_delta(
            'remove-namespace/namespace13.cpp',
            '--transformation=remove-namespace --counter=1',
        )
        self.check_clang_delta(
            'remove-namespace/namespace13.cpp',
    ...
    def test_remove_namespace14(self):
        self.check_clang_delta(
            'remove-namespace/namespace14.cpp',
            '--transformation=remove-namespace --counter=1',
        )

    def test_remove_namespace15(self):
        self.check_clang_delta(
            'remove-namespace/namespace15.cpp',
            '--transformation=remove-namespace --counter=1',
        )
        self.check_clang_delta(
            'remove-namespace/namespace15.cpp',
    ...
    def test_remove_nested_function_remove_nested_func1(self):
        self.check_clang_delta(
            'remove-nested-function/remove_nested_func1.cc',
            '--transformation=remove-nested-function --counter=1',
        )

    def test_remove_try_catch_1(self):
        self.check_clang_delta(
            'remove-try-catch/try-catch-1.cpp',
            '--transformation=remove-try-catch --counter=1',
        )

    def test_remove_try_catch_2(self):
        self.check_clang_delta(
            'remove-try-catch/try-catch-2.cpp',
            '--transformation=remove-try-catch --counter=2',
        )

    def test_remove_unused_field_designated1(self):
        self.check_clang_delta(
            'remove-unused-field/designated1.c',
            '--transformation=remove-unused-field --counter=1',
        )

    def test_remove_unused_field_designated2(self):
        self.check_clang_delta(
            'remove-unused-field/designated2.c',
            '--transformation=remove-unused-field --counter=2',
        )

    def test_remove_unused_field_designated3(self):
        self.check_clang_delta(
            'remove-unused-field/designated3.c',
            '--transformation=remove-unused-field --counter=3',
        )

    def test_remove_unused_field_designated4(self):
        self.check_clang_delta(
            'remove-unused-field/designated4.c',
            '--transformation=remove-unused-field --counter=1',
        )

    def test_remove_unused_field_designated5(self):
        self.check_clang_delta(
            'remove-unused-field/designated5.c',
            '--transformation=remove-unused-field --counter=2',
        )

    def test_remove_unused_field_unused_field1(self):
        self.check_clang_delta(
            'remove-unused-field/unused_field1.c',
            '--transformation=remove-unused-field --counter=1',
        )

    def test_remove_unused_field_unused_field2(self):
        self.check_clang_delta(
            'remove-unused-field/unused_field2.c',
            '--transformation=remove-unused-field --counter=2',
        )

    def test_remove_unused_field_unused_field3(self):
        self.check_clang_delta(
            'remove-unused-field/unused_field3.cpp',
            '--transformation=remove-unused-field --counter=1',
        )
    ...
    def test_rename_class_class_template(self):
        self.check_clang_delta(
            'rename-class/class_template.cc',
            '--transformation=rename-class --counter=1',
        )

    def test_rename_class_class_template2(self):
        self.check_clang_delta(
            'rename-class/class_template2.cc',
            '--transformation=rename-class --counter=1',
        )
    ...
    def test_rename_class_dependent_name(self):
        self.check_clang_delta(
            'rename-class/dependent_name.cpp',
            '--transformation=rename-class --counter=1',
        )
    ...
    def test_rename_class_elaborated_type1(self):
        self.check_clang_delta(
            'rename-class/elaborated_type1.cpp',
            '--transformation=rename-class --counter=1',
        )

    def test_rename_class_elaborated_type2(self):
        self.check_clang_delta(
            'rename-class/elaborated_type2.cpp',
            '--transformation=rename-class --counter=1',
        )

    def test_rename_class_explicit_specialization(self):
        self.check_clang_delta(
            'rename-class/explicit_specialization.cpp',
            '--transformation=rename-class --counter=1',
        )
    ...
    def test_rename_class_injected_name(self):
        self.check_clang_delta(
            'rename-class/injected_name.cpp',
            '--transformation=rename-class --counter=1',
        )

    def test_rename_class_instantiation(self):
        self.check_clang_delta(
            'rename-class/instantiation.cpp',
            '--transformation=rename-class --counter=1',
        )
    ...
    def test_rename_class_partial_specialization(self):
        self.check_clang_delta(
            'rename-class/partial_specialization.cpp',
            '--transformation=rename-class --counter=1',
        )

    def test_rename_class_rename_class1(self):
        self.check_clang_delta(
            'rename-class/rename-class1.cpp',
            '--transformation=rename-class --counter=1',
        )

    def test_rename_class_rename_class2(self):
        self.check_clang_delta(
            'rename-class/rename-class2.cpp',
            '--transformation=rename-class --counter=1',
        )

    def test_rename_class_specialization(self):
        self.check_clang_delta(
            'rename-class/specialization.cpp',
            '--transformation=rename-class --counter=1',
        )
    ...
    def test_rename_class_template_class_1(self):
        self.check_clang_delta(
            'rename-class/template_class_1.cpp',
            '--transformation=rename-class --counter=1',
        )

    def test_rename_class_template_parm(self):
        self.check_clang_delta(
            'rename-class/template_parm.cpp',
            '--transformation=rename-class --counter=1',
        )

    def test_rename_class_template_template(self):
        self.check_clang_delta(
            'rename-class/template_template.cpp',
            '--transformation=rename-class --counter=1',
        )

    def test_rename_class_template_template_parm(self):
        self.check_clang_delta(
            'rename-class/template_template_parm.cpp',
            '--transformation=rename-class --counter=1',
        )
    ...
    def test_rename_cxx_method_overloaded(self):
        self.check_clang_delta(
            'rename-cxx-method/overloaded.cc',
            '--transformation=rename-cxx-method --counter=1',
        )

    def test_rename_cxx_method_test1(self):
        self.check_clang_delta(
            'rename-cxx-method/test1.cc',
            '--transformation=rename-cxx-method --counter=1',
        )

    def test_rename_cxx_method_test2(self):
        self.check_clang_delta(
            'rename-cxx-method/test2.cc',
            '--transformation=rename-cxx-method --counter=1',
        )

    def test_rename_cxx_method_test3(self):
        self.check_clang_delta(
            'rename-cxx-method/test3.cc',
            '--transformation=rename-cxx-method --counter=1',
        )
    ...
    def test_rename_param_stuck(self):
        self.check_error_message(
            'rename-param/stuck.ii',
            '--transformation=rename-param --counter=1',
            'Error: No modification to the transformed program!',
        )
    ...
    def test_replace_derived_class_replace_derived2(self):
        self.check_clang_delta(
            'replace-derived-class/replace-derived2.cpp',
            '--transformation=replace-derived-class --counter=1',
        )

    def test_replace_derived_class_replace_derived3(self):
        self.check_clang_delta(
            'replace-derived-class/replace-derived3.cpp',
            '--transformation=replace-derived-class --counter=1',
        )

    def test_replace_derived_class_replace_derived4(self):
        self.check_clang_delta(
            'replace-derived-class/replace-derived4.cpp',
            '--transformation=replace-derived-class --counter=1',
        )
    ...
    def test_simplify_simple_recursive_template(self):
        self.check_clang_delta(
            'simplify-recursive-template-instantiation/test.cc',
    ...
    def test_template_arg_to_int_not_valid_5(self):
        self.check_query_instances(
            ...
            '--query-instances=template-arg-to-int',
            'Available transformation instances: 0',
        )

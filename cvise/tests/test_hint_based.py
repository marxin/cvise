...
def test_hint_based_last_char_repeatedly(tmp_path: Path):
    ...
    hint_byte0 = Hint(p=[Patch(l=0, r=1)])
    hint_byte1 = Hint(p=[Patch(l=1, r=2)])
    hint_byte2 = Hint(p=[Patch(l=2, r=3)])
    pass_ = StubHintBasedPass(
        {
            b'foo': [hint_byte2],
            b'fo': [hint_byte1],
...
def test_hint_based_state_iteration(tmp_path: Path):
    ...
    hint_bytes01 = Hint(p=[Patch(l=0, r=2)])
    hint_bytes12 = Hint(p=[Patch(l=1, r=3)])
    hint_bytes45 = Hint(p=[Patch(l=4, r=6)])
    hint_bytes2345 = Hint(p=[Patch(l=2, r=6)])
    pass_ = StubHintBasedPass(
        {
...
def test_hint_based_multiple_types(tmp_path: Path):
    ...
    hint_space1 = Hint(t=0, p=[Patch(l=3, r=4)])
    hint_space2 = Hint(t=0, p=[Patch(l=7, r=8)])
    hint_b1 = Hint(t=1, p=[Patch(l=1, r=2)])
    hint_b2 = Hint(t=1, p=[Patch(l=6, r=7)])
    pass_ = StubHintBasedPass(
        {
...
def test_hint_based_type1_fewer_than_type2(tmp_path: Path):
    ...
    """
    vocab = ['type0', 'type1']
    hint1 = Hint(t=0, p=[Patch(l=0, r=1)])
    hint2 = Hint(t=1, p=[Patch(l=1, r=2)])
    hint3 = Hint(t=1, p=[Patch(l=2, r=3)])
    pass_ = StubHintBasedPass(
        {
...
def test_hint_based_type2_fewer_than_type1(tmp_path: Path):
    ...
    vocab = ['type0', 'type1']
    hint1 = Hint(t=0, p=[Patch(l=0, r=1)])
    hint2 = Hint(t=0, p=[Patch(l=1, r=2)])
    hint3 = Hint(t=1, p=[Patch(l=2, r=3)])
    pass_ = StubHintBasedPass(
        {
            b'abc': [hint1, hint2, hint3],
...
def test_hint_based_non_utf8(tmp_path: Path):
    ...
    hint12 = Hint(p=[Patch(l=1, r=2)])
    hint23 = Hint(p=[Patch(l=2, r=3)])
    hint34 = Hint(p=[Patch(l=3, r=4)])
    hint57 = Hint(p=[Patch(l=5, r=7)])
    pass_ = StubHintBasedPass(
        {
...
def test_hint_based_special_hints_not_attempted(tmp_path: Path):
    ...
    hint_regular = Hint(t=0, p=[Patch(l=0, r=1)])
    hint_special = Hint(t=1, p=[Patch(l=1, r=2)])
    pass_ = StubHintBasedPass(
        {

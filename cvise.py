...
if __name__ == '__main__':
    ...
    parser.add_argument('--copy-extra-folder', help='Copy (recursively) the content of the extra folder to temporary before inter. test is run')
    ...
    test_manager = testing.TestManager(pass_statistic, args.interestingness_test, args.timeout,
                                       ...
                                       args.start_with_pass, args.skip_after_n_transforms, args.copy_extra_folder)
